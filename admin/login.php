                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="controller.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0"><button class="btn btn-primary" name="usercheck" value="usercheck">Login</button></div>


                                        </form>
                                    </div>
                                    <div class="row">
                                        <div class="col-xl-6 col-md-6 text-center"><a href="../teacher/login.php">Teacher Login</a></div>

                                        <div class="col-xl-6 col-md-6 text-center"><a href="../login.php">Student Login</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
