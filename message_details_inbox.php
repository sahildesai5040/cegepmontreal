                          ...
                          <div class="card-body col-md-8 justify-content-center">
                                    <form action="controller.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <?php 
                                           ...
                                           $q=$d->select("message_details INNER JOIN users ON  users.user_id = message_details.user_id_from INNER JOIN file_details ON  file_details.file_id = message_details.file_id" ,"message_id='$message_id'","");
